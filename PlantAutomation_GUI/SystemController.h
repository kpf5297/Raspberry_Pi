...
public:
     ...
     */
    void setSoilMoistureCalibrationValues(int16_t wetValue, int16_t dryValue);
...
private:
    ...
    std::string id;                           // ID of the system controller for logging
};
